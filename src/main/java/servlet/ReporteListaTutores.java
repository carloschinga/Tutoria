 ...
 * @author san21
 */
@WebServlet(name = "ReporteTutores", urlPatterns = {"/ReporteListaTutores"})
public class ReporteListaTutores extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ReporteTutoresjpaController reporteTutoresDAO = new ReporteTutoresjpaController(empr);

            // Obtener los datos para el reporte
            List<ReporteTutores> listaReportes = reporteTutoresDAO.getReportData(reporteTutoresParametro);
