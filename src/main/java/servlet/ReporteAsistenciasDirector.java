...
import dao.ReporteAsistenciasjpaController;
 ...
 * @author san21
 */
@WebServlet(name = "ReporteAsistenciasDirector", urlPatterns = {"/ReporteAsistenciasDirector"})
public class ReporteAsistenciasDirector extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String codiDoce= request.getParameter("codigoDocente");
            ...
            ReporteAsistenciasjpaController reporteasistenciasdDAO = new ReporteAsistenciasjpaController(empr);
