...
import dao.ReporteIncidenciasDirectorjpaController;
 ...
 * @author san21
 */
@WebServlet(name = "ReporteIncidenciasDirector", urlPatterns = {"/ReporteIncidenciasDirector"})
public class ReporteIncidenciasDirector extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ReporteIncidenciasDirectorjpaController reporteincidenciasdDAO = new ReporteIncidenciasDirectorjpaController(empr);
            List<IncidenciaTutoriaDTO> listaReportes = reporteincidenciasdDAO.obtenerIncidencias(codiAño,codiSemestre,codidocente);
