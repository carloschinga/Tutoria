...
import dao.TipoIncidenciaJpaController;
 ...
 * @author shaho
 */
@WebServlet(name = "TipoIncidenciaCRUD", urlPatterns = {"/TipoIncidenciaCRUD"})
public class TipoIncidenciaCRUD extends HttpServlet {
