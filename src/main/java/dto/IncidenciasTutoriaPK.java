 ...
 */
@Embeddable
public class IncidenciasTutoriaPK implements Serializable {
    ...
    public IncidenciasTutoriaPK() {
    }

    public IncidenciasTutoriaPK(String codigoSede, String codigoUniversitario, String anio, Character semestre, int item) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof IncidenciasTutoriaPK)) {
            return false;
        }
        IncidenciasTutoriaPK other = (IncidenciasTutoriaPK) object;
    ...
    public String toString() {
        return "dto.IncidenciasTutoriaPK[ codigoSede=" + codigoSede + ", codigoUniversitario=" + codigoUniversitario + ", anio=" + anio + ", semestre=" + semestre + ", item=" + item + " ]";
    }
