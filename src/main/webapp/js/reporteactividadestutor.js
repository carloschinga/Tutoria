$(document).ready(function () {
    ...
    $('#btnImprimir').click(function () {
        ...
        $.ajax({
            url: "ReporteActividadesDirector", // Usamos el servlet que generará el reporte
            method: "GET",
            dataType: "json",
            data: {
                anio: codiAño,
            ...
            success: function (data) {
                 if (data.resultado === "OK" && data.lista.length > 0) {
                    ...
                    alert("No se encontraron actividades para este semestre,con el tutor seleccionado.");
                }
            },
